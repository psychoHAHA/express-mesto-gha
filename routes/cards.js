...
const { cardValidateId, cardValidateInfo, validatePutLikeCard, validateDeleteLikeCard, validateCreateCard, validateDeleteCardById } = require('../middlewares/cardValidation');
